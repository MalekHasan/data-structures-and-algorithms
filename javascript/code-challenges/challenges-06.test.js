...
const getNames = (arr) => {
  // Solution code here...
  const sortedArr=arr.map(ele=>ele.name.split("").reverse().join(""));
  return sortedArr;
};
...
The change should be reflected in the source object that was passed in to the function. That is, the

function should modify the object 'in place'.
