...
const addOne = (arr) => {
  // Solution code here...
  let nweArr=[];
  arr.forEach(element => nweArr.push(++element));
  return nweArr;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let nweArr=[];
  arr.forEach(element => nweArr.push(element.toUpperCase()));
  return nweArr;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let nweArr=[];
  words.forEach(element => nweArr.push(callback(element.toUpperCase())));
  return nweArr;
};
...
const addNumbers = (num, arr, times, callback) => {
  // Solution code here...
  let newArr=new Array(times).fill();
 newArr.forEach(()=>callback(arr,num));
  return arr;
};
